        ...
        */
        ...
        try{
            ...
            if(!(direccionImagen==null)){
                ...
                System.out.println("ANTES ####"+Album.leerArchivoAlbumes(App.pathAlbumes).size());
                Album.agregarNuevoAlbumArchivo(album, App.pathAlbumes);
                
                System.out.println("DESPUES####"+Album.leerArchivoAlbumes(App.pathAlbumes).size());
                System.out.println("ALBUM CREADO: "+album);
